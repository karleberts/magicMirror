...
/**
 * @typedef {object} EventBusClient
 */

/**
 * @returns {EventBusClient}
 */
function createInstance () {
	...
	/**
	 * @name EventBusClient#sendMessage
